...
<link rel="stylesheet" type="text/css" href="/kker_modas/app/assets/css/home_header.css?v=1.0" media="screen" />
...
<header>
    <section class="display-flex-center">
        ...
        <div class="user">
            ...
            <p>
                <?= 'Olá, ' . '<span style="color: #f49910; font-weight: bold">'. strtoupper($_SESSION['user']) .'</span>' ?>
            </p>
            <?php endif; ?>
